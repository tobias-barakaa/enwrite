      ...
      <Container fluid className="hero-layout vh-100 d-flex flex-column justify-content-center">
        <Row className="h-100">
          ...
          <Col
            ...
            style={{ marginTop: '250px' }} // Removed maxWidth
          >
            <div>
          ...
          <Col 
            ...
            style={{ marginTop: "100px", height: "110vh" }} // Removed marginLeft
          >
...
//         <Col 
//         xs={12} md={6} className="position-relative" style={{ marginTop: "100px", marginLeft: "120px", height: "110vh" }}>
//           <div className="d-grid gap-4 h-100" style={{ gridTemplateColumns: "repeat(12, 1fr)" }}>
//             <div
//               className="bg-image item1"
//               style={{
